...
import { Button, ErrorState } from '@booking/ui';
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <ErrorState
        ...
        description="The route you requested does not exist in the admin portal."
      />
      <div className="mt-6 flex justify-center gap-3">
        <Button onClick={() => navigate({ to: '/admin/managePage/dashboard' })}>Go to dashboard</Button>
        <Link to="/loginManager">
          <Button variant="secondary">Manager sign in</Button>
        </Link>
      </div>
    </div>
  );
