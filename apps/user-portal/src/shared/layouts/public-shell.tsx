...
import { clearStoredSession, defaultBookingSearch, useSession } from '@booking/shared';
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            {session ? (
              <>
                {session.role === 'user' ? (
                  <Link to="/profile" className="hidden text-sm font-medium text-slate-700 md:inline-flex">
