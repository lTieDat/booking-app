...
describe('pluralize', () => {
  // Test Case: Singular form when count is exactly 1
  ...
  // Test Case: Plural form when count is greater than 1
  ...
  // Test Case: Singular form when count is 0
  ...
  // Test Case: Custom irregular plural form
  ...
  //Test Case: Large count
  describe('when count is a large number', () => {
    test('returns plural form for large count', () => {
      // Arrange: count = 1000, testing the > 1 condition with large value
      // Act: Call pluralize with count = 1000
      // Assert: Expect plural form "books" to be returned
      expect(pluralize(1000, 'book', 'books')).toBe('books')
    })
  })

  // Additional Test Case: Non-integer count
